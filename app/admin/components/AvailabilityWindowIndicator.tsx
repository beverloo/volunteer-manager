...
/**
 * The <AvailabilityWindowIndicator> component displays an icon, with a tooltip, visualising whether
 * the availability window is currently published, or at what point it will be.
 */
export function AvailabilityWindowIndicator(props: AvailabilityWindowIndicatorProps) {
