...
export enum LogType {
    ...
    AdminHotelAssignmentCreate = 'admin-hotel-assignment-create',
    AdminHotelAssignmentDelete = 'admin-hotel-assignment-delete',
    AdminHotelAssignmentUpdate = 'admin-hotel-assignment-update',
