    ...
    const registration = await dbInstance.selectFrom(tUsersEvents)
        ...
        .select({
            ...
            hotelPreferences: {
                ...
                checkIn: dbInstance.asDateString(
                    hotelsPreferencesJoin.hotelDateCheckIn, 'optional'),
                checkOut: dbInstance.asDateString(
                    hotelsPreferencesJoin.hotelDateCheckOut, 'optional'),
    ...
    application: ApplicationData): Promise<void>
{
    ...
    const affectedRows = await dbInstance.insertInto(tUsersEvents)
        .set({
            ...
            registrationDate: dbInstance.currentDateTime2(),
