...
export class TrainingsTable extends Table<DBConnection, 'TrainingsTable'> {
    ...
    trainingStart = this.columnWithDefaultValue<ZonedDateTime>('training_start', 'customComparable', 'dateTime', TemporalTypeAdapter);
    trainingEnd = this.columnWithDefaultValue<ZonedDateTime>('training_end', 'customComparable', 'dateTime', TemporalTypeAdapter);
